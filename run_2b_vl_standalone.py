"""
run_2b_vl_standalone.py
Qwen3-VL-2B-Thinking standalone baseline on MathVision VL questions.
...
RESULTS_PATH  = f"{RESULTS_DIR}/run_2b_vl_standalone_results.json"
